...
type PulseDistributorMock struct {
	...
	funcDistribute          func(ctx context.Context, p1 Pulse)
	inspectFuncDistribute   func(ctx context.Context, p1 Pulse)
...
func (mmDistribute *mPulseDistributorMockDistribute) Expect(ctx context.Context, p1 Pulse) *mPulseDistributorMockDistribute {
...
func (mmDistribute *mPulseDistributorMockDistribute) Inspect(f func(ctx context.Context, p1 Pulse)) *mPulseDistributorMockDistribute {
...
func (mmDistribute *mPulseDistributorMockDistribute) Set(f func(ctx context.Context, p1 Pulse)) *PulseDistributorMock {
	if mmDistribute.defaultExpectation != nil {
...
func (mmDistribute *PulseDistributorMock) Distribute(ctx context.Context, p1 Pulse) {
