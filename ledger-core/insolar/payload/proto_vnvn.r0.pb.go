...
const (
	CTInvalid         CallType = 0
	CTInboundAPICall  CallType = 1
	CTOutboundAPICall CallType = 2
	CTMethod          CallType = 3
	CTConstructor     CallType = 4
	CTNotifyCall      CallType = 5
	CTSAGACall        CallType = 6
	CTParallelCall    CallType = 7
	CTScheduleCall    CallType = 8
)
...
const (
	UnknownCachedMemoryState  VCachedMemoryResponse_Status = 0
	FoundCachedMemoryState    VCachedMemoryResponse_Status = 1
	RedirectCachedMemoryState VCachedMemoryResponse_Status = 2
	MissingCachedMemoryState  VCachedMemoryResponse_Status = 3
)

var VCachedMemoryResponse_Status_name = map[int32]string{
	0: "UnknownCachedMemoryState",
	1: "FoundCachedMemoryState",
	2: "RedirectCachedMemoryState",
	3: "MissingCachedMemoryState",
}

var VCachedMemoryResponse_Status_value = map[string]int32{
	"UnknownCachedMemoryState":  0,
	"FoundCachedMemoryState":    1,
	"RedirectCachedMemoryState": 2,
	"MissingCachedMemoryState":  3,
}
...
func (m *VCachedMemoryResponse) GetCallStatus() VCachedMemoryResponse_Status {
	...
	return UnknownCachedMemoryState
}
...
var fileDescriptor_8a268ff04305613a = []byte{
	...
	,
}
