...
// PulseAppenderMock implements PulseAppender
type PulseAppenderMock struct {
	t minimock.Tester

	funcAppendPulse          func(ctx context.Context, p1 PulseChange) (err error)
	inspectFuncAppendPulse   func(ctx context.Context, p1 PulseChange)
	afterAppendPulseCounter  uint64
	beforeAppendPulseCounter uint64
	AppendPulseMock          mPulseAppenderMockAppendPulse
}

// NewPulseAppenderMock returns a mock for PulseAppender
...
func (mmAppendPulse *mPulseAppenderMockAppendPulse) Expect(ctx context.Context, p1 PulseChange) *mPulseAppenderMockAppendPulse {
	...
	mmAppendPulse.defaultExpectation.params = &PulseAppenderMockAppendPulseParams{ctx, p1}
...
func (mmAppendPulse *mPulseAppenderMockAppendPulse) Inspect(f func(ctx context.Context, p1 PulseChange)) *mPulseAppenderMockAppendPulse {
...
func (mmAppendPulse *mPulseAppenderMockAppendPulse) Set(f func(ctx context.Context, p1 PulseChange) (err error)) *PulseAppenderMock {
	if mmAppendPulse.defaultExpectation != nil {
...
// Then helper
func (mmAppendPulse *mPulseAppenderMockAppendPulse) When(ctx context.Context, p1 PulseChange) *PulseAppenderMockAppendPulseExpectation {
	if mmAppendPulse.mock.funcAppendPulse != nil {
		mmAppendPulse.mock.t.Fatalf("PulseAppenderMock.AppendPulse mock is already set by Set")
	}
	...
	expectation := &PulseAppenderMockAppendPulseExpectation{
		...
		params: &PulseAppenderMockAppendPulseParams{ctx, p1},
	}
...
// AppendPulse implements PulseAppender
func (mmAppendPulse *PulseAppenderMock) AppendPulse(ctx context.Context, p1 PulseChange) (err error) {
	...
	if mmAppendPulse.inspectFuncAppendPulse != nil {
		mmAppendPulse.inspectFuncAppendPulse(ctx, p1)
	}

	mm_params := &PulseAppenderMockAppendPulseParams{ctx, p1}
	...
	if mmAppendPulse.AppendPulseMock.defaultExpectation != nil {
		...
		mm_got := PulseAppenderMockAppendPulseParams{ctx, p1}
	...
	if mmAppendPulse.funcAppendPulse != nil {
		return mmAppendPulse.funcAppendPulse(ctx, p1)
	}
	mmAppendPulse.t.Fatalf("Unexpected call to PulseAppenderMock.AppendPulse. %v %v", ctx, p1)
	return
}
