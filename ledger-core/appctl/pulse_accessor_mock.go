...
// PulseAccessorMock implements PulseAccessor
type PulseAccessorMock struct {
	t minimock.Tester

	funcGetLatestPulse          func(ctx context.Context) (p1 PulseChange, err error)
	...
	funcGetPulse          func(ctx context.Context, n1 pulse.Number) (p1 PulseChange, err error)
...
// NewPulseAccessorMock returns a mock for PulseAccessor
...
func (mmGetLatestPulse *mPulseAccessorMockGetLatestPulse) Return(p1 PulseChange, err error) *PulseAccessorMock {
	if mmGetLatestPulse.mock.funcGetLatestPulse != nil {
		mmGetLatestPulse.mock.t.Fatalf("PulseAccessorMock.GetLatestPulse mock is already set by Set")
	}
...
func (mmGetLatestPulse *mPulseAccessorMockGetLatestPulse) Set(f func(ctx context.Context) (p1 PulseChange, err error)) *PulseAccessorMock {
	if mmGetLatestPulse.defaultExpectation != nil {
...
func (e *PulseAccessorMockGetLatestPulseExpectation) Then(p1 PulseChange, err error) *PulseAccessorMock {
	e.results = &PulseAccessorMockGetLatestPulseResults{p1, err}
	return e.mock
}

// GetLatestPulse implements PulseAccessor
func (mmGetLatestPulse *PulseAccessorMock) GetLatestPulse(ctx context.Context) (p1 PulseChange, err error) {
...
func (mmGetPulse *mPulseAccessorMockGetPulse) Return(p1 PulseChange, err error) *PulseAccessorMock {
	if mmGetPulse.mock.funcGetPulse != nil {
		mmGetPulse.mock.t.Fatalf("PulseAccessorMock.GetPulse mock is already set by Set")
	}
...
func (mmGetPulse *mPulseAccessorMockGetPulse) Set(f func(ctx context.Context, n1 pulse.Number) (p1 PulseChange, err error)) *PulseAccessorMock {
	if mmGetPulse.defaultExpectation != nil {
...
func (e *PulseAccessorMockGetPulseExpectation) Then(p1 PulseChange, err error) *PulseAccessorMock {
	e.results = &PulseAccessorMockGetPulseResults{p1, err}
	return e.mock
}

// GetPulse implements PulseAccessor
func (mmGetPulse *PulseAccessorMock) GetPulse(ctx context.Context, n1 pulse.Number) (p1 PulseChange, err error) {
