...
// VirtualValidatorForObject returns list of VEs for a provided pulse and objID
func (jc *Coordinator) VirtualValidatorForObject(objID reference.Holder, pn pulse.Number) (reference.Global, error) {
	pc, err := jc.PulseAccessor.TimeBeat(pn)
	switch {
	case err != nil:
		return reference.Global{}, err
