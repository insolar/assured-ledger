...
type AppenderMock struct {
	...
	funcAppend          func(ctx context.Context, pulse PulseChange) (err error)
	inspectFuncAppend   func(ctx context.Context, pulse PulseChange)
...
func (mmAppend *mAppenderMockAppend) Expect(ctx context.Context, pulse PulseChange) *mAppenderMockAppend {
...
func (mmAppend *mAppenderMockAppend) Inspect(f func(ctx context.Context, pulse PulseChange)) *mAppenderMockAppend {
...
func (mmAppend *mAppenderMockAppend) Set(f func(ctx context.Context, pulse PulseChange) (err error)) *AppenderMock {
	if mmAppend.defaultExpectation != nil {
...
// Then helper
func (mmAppend *mAppenderMockAppend) When(ctx context.Context, pulse PulseChange) *AppenderMockAppendExpectation {
	if mmAppend.mock.funcAppend != nil {
		mmAppend.mock.t.Fatalf("AppenderMock.Append mock is already set by Set")
	}
...
func (mmAppend *AppenderMock) Append(ctx context.Context, pulse PulseChange) (err error) {
