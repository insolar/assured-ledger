...
func NewFuture(requestID types.RequestID, receiver nwapi.Address, packet *rms.Packet, cancelCallback CancelCallback) Future {
...
func (f *future) Receiver() nwapi.Address {
	return f.receiver
}
