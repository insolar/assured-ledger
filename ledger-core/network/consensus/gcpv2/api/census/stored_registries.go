...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/network/consensus/gcpv2/api/census.VersionedRegistries -o . -s _mock.go -g
...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/network/consensus/gcpv2/api/census.MisbehaviorRegistry -o . -s _mock.go -g

type MisbehaviorRegistry interface {
	AddReport(report misbehavior.Report)
}

//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/network/consensus/gcpv2/api/census.MandateRegistry -o . -s _mock.go -g
