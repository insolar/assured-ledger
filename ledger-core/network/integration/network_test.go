...
func TestNodeConnectInvalidVersion(t *testing.T) {
	...
	s.InitNode(testNode)
	// testNode.serviceNetwork.PulseHistory.GetOrigin().(node.MutableNode).SetVersion("ololo")
	// require.Equal(t, "ololo", testNode.serviceNetwork.PulseHistory.GetOrigin().Version())
