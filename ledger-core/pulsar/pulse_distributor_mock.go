...
type PulseDistributorMock struct {
	...
	funcDistribute          func(ctx context.Context, p1 PulsePacket)
	inspectFuncDistribute   func(ctx context.Context, p1 PulsePacket)
...
func (mmDistribute *mPulseDistributorMockDistribute) Expect(ctx context.Context, p1 PulsePacket) *mPulseDistributorMockDistribute {
...
func (mmDistribute *mPulseDistributorMockDistribute) Inspect(f func(ctx context.Context, p1 PulsePacket)) *mPulseDistributorMockDistribute {
...
func (mmDistribute *mPulseDistributorMockDistribute) Set(f func(ctx context.Context, p1 PulsePacket)) *PulseDistributorMock {
	if mmDistribute.defaultExpectation != nil {
