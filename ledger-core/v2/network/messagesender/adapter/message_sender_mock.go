...
type MessageSenderMock struct {
	...
	funcPrepareAsync          func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service) smachine.AsyncResultFunc) (a1 smachine.AsyncCallRequester)
	inspectFuncPrepareAsync   func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service) smachine.AsyncResultFunc)
	afterPrepareAsyncCounter  uint64
	beforePrepareAsyncCounter uint64
	PrepareAsyncMock          mMessageSenderMockPrepareAsync

	funcPrepareNotify          func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) (n1 smachine.NotifyRequester)
	inspectFuncPrepareNotify   func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service))
	afterPrepareNotifyCounter  uint64
	beforePrepareNotifyCounter uint64
	PrepareNotifyMock          mMessageSenderMockPrepareNotify

	funcPrepareSync          func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) (s1 smachine.SyncCallRequester)
	inspectFuncPrepareSync   func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service))
...
func (mmPrepareAsync *mMessageSenderMockPrepareAsync) Expect(e1 smachine.ExecutionContext, fn func(svc messagesender.Service) smachine.AsyncResultFunc) *mMessageSenderMockPrepareAsync {
...
func (mmPrepareAsync *mMessageSenderMockPrepareAsync) Inspect(f func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service) smachine.AsyncResultFunc)) *mMessageSenderMockPrepareAsync {
...
func (mmPrepareAsync *mMessageSenderMockPrepareAsync) Set(f func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service) smachine.AsyncResultFunc) (a1 smachine.AsyncCallRequester)) *MessageSenderMock {
	if mmPrepareAsync.defaultExpectation != nil {
...
// Then helper
func (mmPrepareAsync *mMessageSenderMockPrepareAsync) When(e1 smachine.ExecutionContext, fn func(svc messagesender.Service) smachine.AsyncResultFunc) *MessageSenderMockPrepareAsyncExpectation {
	if mmPrepareAsync.mock.funcPrepareAsync != nil {
		mmPrepareAsync.mock.t.Fatalf("MessageSenderMock.PrepareAsync mock is already set by Set")
	}
...
func (mmPrepareAsync *MessageSenderMock) PrepareAsync(e1 smachine.ExecutionContext, fn func(svc messagesender.Service) smachine.AsyncResultFunc) (a1 smachine.AsyncCallRequester) {
...
func (mmPrepareNotify *mMessageSenderMockPrepareNotify) Expect(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) *mMessageSenderMockPrepareNotify {
...
func (mmPrepareNotify *mMessageSenderMockPrepareNotify) Inspect(f func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service))) *mMessageSenderMockPrepareNotify {
...
func (mmPrepareNotify *mMessageSenderMockPrepareNotify) Set(f func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) (n1 smachine.NotifyRequester)) *MessageSenderMock {
	if mmPrepareNotify.defaultExpectation != nil {
...
// Then helper
func (mmPrepareNotify *mMessageSenderMockPrepareNotify) When(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) *MessageSenderMockPrepareNotifyExpectation {
	if mmPrepareNotify.mock.funcPrepareNotify != nil {
		mmPrepareNotify.mock.t.Fatalf("MessageSenderMock.PrepareNotify mock is already set by Set")
	}
...
func (mmPrepareNotify *MessageSenderMock) PrepareNotify(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) (n1 smachine.NotifyRequester) {
...
func (mmPrepareSync *mMessageSenderMockPrepareSync) Expect(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) *mMessageSenderMockPrepareSync {
...
func (mmPrepareSync *mMessageSenderMockPrepareSync) Inspect(f func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service))) *mMessageSenderMockPrepareSync {
...
func (mmPrepareSync *mMessageSenderMockPrepareSync) Set(f func(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) (s1 smachine.SyncCallRequester)) *MessageSenderMock {
	if mmPrepareSync.defaultExpectation != nil {
...
// Then helper
func (mmPrepareSync *mMessageSenderMockPrepareSync) When(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) *MessageSenderMockPrepareSyncExpectation {
	if mmPrepareSync.mock.funcPrepareSync != nil {
		mmPrepareSync.mock.t.Fatalf("MessageSenderMock.PrepareSync mock is already set by Set")
	}
...
func (mmPrepareSync *MessageSenderMock) PrepareSync(e1 smachine.ExecutionContext, fn func(svc messagesender.Service)) (s1 smachine.SyncCallRequester) {
