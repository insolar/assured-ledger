...
type MessengerMock struct {
	...
	funcSendRole          func(ctx context.Context, msg Marshaler, role insolar.DynamicRole, object insolar.Reference, pn pulse.Number, opts ...SendOption) (err error)
	inspectFuncSendRole   func(ctx context.Context, msg Marshaler, role insolar.DynamicRole, object insolar.Reference, pn pulse.Number, opts ...SendOption)
	afterSendRoleCounter  uint64
	beforeSendRoleCounter uint64
	SendRoleMock          mMessengerMockSendRole

	funcSendTarget          func(ctx context.Context, msg Marshaler, target insolar.Reference, opts ...SendOption) (err error)
	inspectFuncSendTarget   func(ctx context.Context, msg Marshaler, target insolar.Reference, opts ...SendOption)
...
func (mmSendRole *mMessengerMockSendRole) Expect(ctx context.Context, msg Marshaler, role insolar.DynamicRole, object insolar.Reference, pn pulse.Number, opts ...SendOption) *mMessengerMockSendRole {
...
func (mmSendRole *mMessengerMockSendRole) Inspect(f func(ctx context.Context, msg Marshaler, role insolar.DynamicRole, object insolar.Reference, pn pulse.Number, opts ...SendOption)) *mMessengerMockSendRole {
...
func (mmSendRole *mMessengerMockSendRole) Set(f func(ctx context.Context, msg Marshaler, role insolar.DynamicRole, object insolar.Reference, pn pulse.Number, opts ...SendOption) (err error)) *MessengerMock {
	if mmSendRole.defaultExpectation != nil {
...
// Then helper
func (mmSendRole *mMessengerMockSendRole) When(ctx context.Context, msg Marshaler, role insolar.DynamicRole, object insolar.Reference, pn pulse.Number, opts ...SendOption) *MessengerMockSendRoleExpectation {
	if mmSendRole.mock.funcSendRole != nil {
		mmSendRole.mock.t.Fatalf("MessengerMock.SendRole mock is already set by Set")
	}
...
func (mmSendRole *MessengerMock) SendRole(ctx context.Context, msg Marshaler, role insolar.DynamicRole, object insolar.Reference, pn pulse.Number, opts ...SendOption) (err error) {
...
func (mmSendTarget *mMessengerMockSendTarget) Expect(ctx context.Context, msg Marshaler, target insolar.Reference, opts ...SendOption) *mMessengerMockSendTarget {
...
func (mmSendTarget *mMessengerMockSendTarget) Inspect(f func(ctx context.Context, msg Marshaler, target insolar.Reference, opts ...SendOption)) *mMessengerMockSendTarget {
...
func (mmSendTarget *mMessengerMockSendTarget) Set(f func(ctx context.Context, msg Marshaler, target insolar.Reference, opts ...SendOption) (err error)) *MessengerMock {
	if mmSendTarget.defaultExpectation != nil {
...
// Then helper
func (mmSendTarget *mMessengerMockSendTarget) When(ctx context.Context, msg Marshaler, target insolar.Reference, opts ...SendOption) *MessengerMockSendTargetExpectation {
	if mmSendTarget.mock.funcSendTarget != nil {
		mmSendTarget.mock.t.Fatalf("MessengerMock.SendTarget mock is already set by Set")
	}
...
func (mmSendTarget *MessengerMock) SendTarget(ctx context.Context, msg Marshaler, target insolar.Reference, opts ...SendOption) (err error) {
