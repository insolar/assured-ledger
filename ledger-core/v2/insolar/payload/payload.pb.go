...
type ServiceData struct {
	...
	LogLevel      github_com_insolar_insolar_insolar.LogLevel `protobuf:"varint,21,opt,name=LogLevel,proto3,customtype=github.com/insolar/assured-ledger/ledger-core/v2/insolar.LogLevel" json:"LogLevel"`
