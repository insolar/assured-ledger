...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/insolar/flow.Procedure -o . -s _mock.go -g
...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/insolar/flow.Flow -o . -s _mock.go -g
