...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/insolar/store.JetIndexModifier -o ./ -s _mock.go -g -g
...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/insolar/store.JetIndexAccessor -o ./ -s _mock.go -g
