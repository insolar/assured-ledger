...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/insolar/store.DB -o ./ -s _gen_mock.go -g
...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/insolar/store.Iterator -o ./ -s _gen_mock.go -g
