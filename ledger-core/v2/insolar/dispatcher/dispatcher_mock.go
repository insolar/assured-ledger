...
type DispatcherMock struct {
	...
	funcBeginPulse          func(ctx context.Context, pulse pulsestor.Pulse)
	inspectFuncBeginPulse   func(ctx context.Context, pulse pulsestor.Pulse)
	afterBeginPulseCounter  uint64
	beforeBeginPulseCounter uint64
	BeginPulseMock          mDispatcherMockBeginPulse

	funcClosePulse          func(ctx context.Context, pulse pulsestor.Pulse)
	inspectFuncClosePulse   func(ctx context.Context, pulse pulsestor.Pulse)
...
func (mmBeginPulse *mDispatcherMockBeginPulse) Expect(ctx context.Context, pulse pulsestor.Pulse) *mDispatcherMockBeginPulse {
...
func (mmBeginPulse *mDispatcherMockBeginPulse) Inspect(f func(ctx context.Context, pulse pulsestor.Pulse)) *mDispatcherMockBeginPulse {
...
func (mmBeginPulse *mDispatcherMockBeginPulse) Set(f func(ctx context.Context, pulse pulsestor.Pulse)) *DispatcherMock {
	if mmBeginPulse.defaultExpectation != nil {
...
func (mmBeginPulse *DispatcherMock) BeginPulse(ctx context.Context, pulse pulsestor.Pulse) {
...
func (mmClosePulse *mDispatcherMockClosePulse) Expect(ctx context.Context, pulse pulsestor.Pulse) *mDispatcherMockClosePulse {
...
func (mmClosePulse *mDispatcherMockClosePulse) Inspect(f func(ctx context.Context, pulse pulsestor.Pulse)) *mDispatcherMockClosePulse {
...
func (mmClosePulse *mDispatcherMockClosePulse) Set(f func(ctx context.Context, pulse pulsestor.Pulse)) *DispatcherMock {
	if mmClosePulse.defaultExpectation != nil {
...
func (mmClosePulse *DispatcherMock) ClosePulse(ctx context.Context, pulse pulsestor.Pulse) {
