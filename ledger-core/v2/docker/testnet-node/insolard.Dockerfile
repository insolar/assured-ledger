...
COPY --from=insolar-base          \
       [ "/go/src/github.com/insolar/assured-ledger/ledger-core/v2/bin/insolar",      \
         "/go/src/github.com/insolar/assured-ledger/ledger-core/v2/bin/insolard",     \
         "/go/src/github.com/insolar/assured-ledger/ledger-core/v2/bin/benchmark",    \
         "/go/src/github.com/insolar/assured-ledger/ledger-core/v2/bin/apirequester", \
                                  \
         "/opt/bin/"]
