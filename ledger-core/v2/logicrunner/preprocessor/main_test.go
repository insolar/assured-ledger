...
import (
	...
	"github.com/insolar/assured-ledger/ledger-core/v2/logicrunner/goplugin/goplugintestutils"
)
...
`)
	...
	s.Contains(bufProxy.String(), `"github.com/insolar/assured-ledger/ledger-core/v2/logicrunner/common"`)
...
`)
	...
	s.NotContains(bufProxy.String(), `"github.com/insolar/assured-ledger/ledger-core/v2/logicrunner/common"`)
}
