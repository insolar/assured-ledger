...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/ledger/light/executor.FilamentCalculator -o ./ -s _mock.go -g
...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/ledger/light/executor.FilamentCleaner -o ./ -s _mock.go -g
