...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/ledger/light/executor.JetWaiter -o ./ -s _mock.go -g
...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/ledger/light/executor.JetReleaser -o ./ -s _mock.go -g
