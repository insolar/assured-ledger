...
import (
	...
	"github.com/insolar/assured-ledger/ledger-core/v2/insolar/backoff"
...
//go:generate minimock -i github.com/insolar/assured-ledger/ledger-core/v2/ledger/light/executor.StateIniter -o ./ -s _mock.go -g
