...
type CertificateGetterMock struct {
	...
	funcGetCert          func(ctx context.Context, g1 reference.Global) (c2 mm_nodeinfo.Certificate, err error)
...
func (mmGetCert *mCertificateGetterMockGetCert) Return(c2 mm_nodeinfo.Certificate, err error) *CertificateGetterMock {
	if mmGetCert.mock.funcGetCert != nil {
		mmGetCert.mock.t.Fatalf("CertificateGetterMock.GetCert mock is already set by Set")
	}
...
func (mmGetCert *mCertificateGetterMockGetCert) Set(f func(ctx context.Context, g1 reference.Global) (c2 mm_nodeinfo.Certificate, err error)) *CertificateGetterMock {
	if mmGetCert.defaultExpectation != nil {
...
func (e *CertificateGetterMockGetCertExpectation) Then(c2 mm_nodeinfo.Certificate, err error) *CertificateGetterMock {
