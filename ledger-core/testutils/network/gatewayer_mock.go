...
type GatewayerMock struct {
	...
	funcSwitchState          func(ctx context.Context, s1 mm_network.State, d1 pulse.Data)
	inspectFuncSwitchState   func(ctx context.Context, s1 mm_network.State, d1 pulse.Data)
...
func (mmSwitchState *mGatewayerMockSwitchState) Expect(ctx context.Context, s1 mm_network.State, d1 pulse.Data) *mGatewayerMockSwitchState {
	...
	mmSwitchState.defaultExpectation.params = &GatewayerMockSwitchStateParams{ctx, s1, d1}
...
func (mmSwitchState *mGatewayerMockSwitchState) Inspect(f func(ctx context.Context, s1 mm_network.State, d1 pulse.Data)) *mGatewayerMockSwitchState {
...
func (mmSwitchState *mGatewayerMockSwitchState) Set(f func(ctx context.Context, s1 mm_network.State, d1 pulse.Data)) *GatewayerMock {
	if mmSwitchState.defaultExpectation != nil {
...
func (mmSwitchState *GatewayerMock) SwitchState(ctx context.Context, s1 mm_network.State, d1 pulse.Data) {
	...
	if mmSwitchState.inspectFuncSwitchState != nil {
		mmSwitchState.inspectFuncSwitchState(ctx, s1, d1)
	}

	mm_params := &GatewayerMockSwitchStateParams{ctx, s1, d1}
	...
	if mmSwitchState.SwitchStateMock.defaultExpectation != nil {
		...
		mm_got := GatewayerMockSwitchStateParams{ctx, s1, d1}
	...
	if mmSwitchState.funcSwitchState != nil {
		mmSwitchState.funcSwitchState(ctx, s1, d1)
		return
	}
	mmSwitchState.t.Fatalf("Unexpected call to GatewayerMock.SwitchState. %v %v %v", ctx, s1, d1)
