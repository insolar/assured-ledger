...
func (m *AsyncCallRequesterSendRoleMock) SetCheckMessage(fn func(rmsreg.GoGoSerializable)) *AsyncCallRequesterSendRoleMock {
	m.prepare()
	m.checkMessageFn = fn
	return m
...
func (m *AsyncCallRequesterSendTargetMock) SetCheckMessage(fn func(rmsreg.GoGoSerializable)) *AsyncCallRequesterSendTargetMock {
	m.prepare()
	m.checkMessageFn = fn
	return m
